...
output "cluster_region" {
  description = "The region of the Dataproc cluster"
  value       = google_dataproc_cluster.cluster.region
}

output "cluster_project" {
  description = "The project ID of the Dataproc cluster"
  value       = google_dataproc_cluster.cluster.project
}
